<?php
// Heading
$_['heading_title']                         = 'Експорт / Імпорт продуктів';

// Text
$_['text_success']                          = 'Вітаємо: Ви успішно імпортували свої дані!';
$_['text_success_settings']                 = 'Вітаємо: Ви успішно оновили налаштування інструмента Експорт / Імпорт!';
$_['text_export_type_category']             = 'Категорії (включаючи категорії та фільтри)';
$_['text_export_type_category_old']         = 'Категорії';
$_['text_export_type_product']              = 'Продукти (включаючи дані про продукт, варіанти, спеціальні пропозиції, знижки, винагороди, атрибути та фільтри)';
$_['text_export_type_product_old']          = 'Продукти (включаючи дані про продукт, варіанти, спеціальні пропозиції, знижки, винагороди та атрибути)';
$_['text_export_type_option']               = 'Визначення опції';
$_['text_export_type_attribute']            = 'Визначення атрибуту';
$_['text_export_type_filter']               = 'Визначення фільтра';
...
// Entry
$_['entry_import']                          = 'Імпортувати з файлу електронних таблиць XLS, XLSX або ODS';
$_['entry_export']                          = 'Експорт запитує дані в файл таблиці XLSX.';
$_['entry_export_type']                     = 'Виберіть дані, які потрібно експортувати:';
$_['entry_range_type']                      = 'Виберіть діапазон даних, який ви хочете експортувати:';
$_['entry_start_id']                        = 'Start id:';
$_['entry_start_index']                     = 'Counts per batch:';
$_['entry_end_id']                          = 'End id:';
$_['entry_end_index']                       = 'The batch number:';
$_['entry_incremental']                     = 'Використовуйте послідовний імпорт';
...
// Help
$_['help_range_type']                       = '(Необов\'язково, залиште порожнім, якщо це не потрібно)';
$_['help_incremental_yes']                  = '(Оновити та/або додати дані)';
$_['help_incremental_no']                   = '(Видалити всі старі дані перед імпортом)';
$_['help_import']                           = 'Таблиця може мати категорії, продукти, визначення атрибутів, визначення параметрів або визначення фільтрів.';
$_['help_import_old']                       = 'Таблиця може мати категорії, продукти, визначення атрибутів або визначення параметрів. ';
$_['help_format']                           = 'Спершу експортуйте, щоб побачити точний формат робочих таблиць!';
?>